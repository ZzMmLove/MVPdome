...
public class PDFActivity extends AppCompatActivity {
    ...
    //private String fileUrl = "http://shuoke360.cn/Public/Uploads/Note/20170925/59c8840e7c231.ppt";
    ...
    private void initView() {
        ...
        mWebView.addJavascriptInterface(new JsObject(this, fileUrl), "client"); // js与Android交互

        mWebView.loadUrl(pdfHtml);  // Android 与js交互
