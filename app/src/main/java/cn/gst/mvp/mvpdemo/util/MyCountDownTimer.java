...
import cn.gst.mvp.mvpdemo.view.BackgroundSpan;
...
public class MyCountDownTimer extends CountDownTimer {
    ...
    public void initSpanData(String timeStr) {
        ...
        for (int i = 0; i < numbers.length; i++) {
            BackgroundSpan backgroundColorSpan = new BackgroundSpan(ContextCompat.getDrawable(mContext, mDrawableId), ImageSpan.ALIGN_BASELINE);
